...
#		return self._write4444(address,self.Cmd.SETM1PID,long(d*65536),long(p*65536),long(i*65536),qpps)
		return self._write4444(address,self.Cmd.SETM1PID,int(round(d*65536)),int(round(p*65536)),int(round(i*65536)),int(qpps))
...
#		return self._write4444(address,self.Cmd.SETM2PID,long(d*65536),long(p*65536),long(i*65536),qpps)
		return self._write4444(address,self.Cmd.SETM2PID,int(round(d*65536)),int(round(p*65536)),int(round(i*65536)),int(qpps))
